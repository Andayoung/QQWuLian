    ...
    public TraeAudioSession(Context ctx, ITraeAudioCallback cb) {
        ...
        if (null == ctx) {
            if (QLog.isColorLevel())
                QLog.w("TRAE", QLog.CLR, "AudioSession | Invalid parameters: ctx = "
			...
			*/
            if (TraeAudioManager.ACTION_TRAEAUDIOMANAGER_NOTIFY.equals(intent
                ...
                if (TraeAudioManager.NOTIFY_SERVICE_STATE.equals(strOperation)) {
                    ...
                    if (QLog.isColorLevel())
                        QLog.w("TRAE", QLog.CLR, "AudioSession|[onServiceStateUpdate]"
                                + (on ? "on" : "off"));
                    if (null != mCallback) {
                    ...
                    if (QLog.isColorLevel())
                        QLog.w("TRAE", QLog.CLR, "AudioSession|[onDeviceListUpdate] "
                    ...
                    boolean bIsChangabled = intent.getBooleanExtra(
                            ...
                            true);
                    if (QLog.isColorLevel())
                        QLog.w("TRAE", QLog.CLR, "AudioSession|[onDeviceChangabledUpdate]"
                                + bIsChangabled);
                    if (null != mCallback) {
                    ...
                    if (QLog.isColorLevel())
                        QLog.w("TRAE", QLog.CLR, "AudioSession|[onStreamTypeUpdate] err:"
                                + errCode + " st:" + st);
                ...
                if (TraeAudioManager.OPERATION_GETDEVICELIST.equals(strOperation)) {
                    ...
                    _connectedDev = con;
                    if (QLog.isColorLevel())
                        QLog.w("TRAE", QLog.CLR, "AudioSession|[onGetDeviceListRes] err:"
                    ...
                    if (QLog.isColorLevel())
                        QLog.w("TRAE", QLog.CLR, "AudioSession|[onConnectDeviceRes] err:"
                    ...
                    boolean bIsChangabled = intent
                            .getBooleanExtra(
                                    ...
                                    false);
                    if (QLog.isColorLevel())
                        QLog.w("TRAE", QLog.CLR, "AudioSession|[onIsDeviceChangabledRes] err:"
                                + errCode + " Changabled:"
                                + (bIsChangabled ? "Y" : "N"));
                    ...
                    if (QLog.isColorLevel())
                        QLog.w("TRAE", QLog.CLR, "AudioSession|[onGetConnectedDeviceRes] err:"
                                + errCode + " dev:" + strDeviceName);
                    ...
                    if (QLog.isColorLevel())
                        QLog.w("TRAE", QLog.CLR, "AudioSession|[onGetConnectingDeviceRes] err:"
                                + errCode + " dev:" + strDeviceName);
                    ...
                    int st = intent
                            .getIntExtra(TraeAudioManager.EXTRA_DATA_STREAMTYPE, -1);
                    if (QLog.isColorLevel())
                        QLog.w("TRAE", QLog.CLR, "AudioSession|[onGetStreamTypeRes] err:"
                                + errCode + " st:" + st);
                    ...
                    if (QLog.isColorLevel())
                        QLog.w("TRAE", QLog.CLR, "AudioSession|[onRingCompletion] err:"
                    ...
                    if (QLog.isColorLevel())
                        QLog.w("TRAE", QLog.CLR, "AudioSession|[onVoicecallPreprocess] err:"
                                + errCode);
                    if (null != mCallback) {
            ...
            if (QLog.isColorLevel())
                QLog.e("TRAE", QLog.CLR, "AudioSession| nSessinId = " + mSessionId
                        + " onReceive::intent:" +
